...
<section class='solarcalc'>
    ...
    <div class='output-con'>
        <div id="sc-power" class='item'>
            ...
            <div class="name"><?php echo __('Leistung in kWp', 'solarcalc') ?></div>
        </div>
        ...
        <div id="sc-energy" class='item'>
            ...
            <div class="number"></div>
            <div class="name"><?php echo __('Energieertrag in kWh/Jahr', 'solarcalc') ?></div>
        </div>
        <div id="sc-invest" class='item'>
            ...
            <div class="name">
                ...
                <span class="info">
                    ...
                    <div class="text">
                        Die Einmalvergültung (EIV) ab 2 kWp wurde mit eingerechnet. <a href="https://pronovo.ch/" target="_blank">Pronovo</a>
                    </div>
                </span>
            </div>
        </div>
